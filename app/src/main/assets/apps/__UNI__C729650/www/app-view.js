...
Z([3,'true'])
Z([3,'primary'])
Z([3,'通过Toast显示“hello uniapp for android plugin”'])
...
cs.push("./pages/index/index.wxml:button:1:45")
var xC=_mz(z,'button',['bindtap',2,'data-event-opts',1,'plain',2,'type',3],[],e,s,gg)
